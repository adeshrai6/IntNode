 ...
 *
 * @see <A HREF="../../../../edu/colorado/nodes/IntNode.java"> Java Source Code
 *      for this class
...
public class IntNode {
   ...
   * 
   * @param start/end         references to two nodes of a linked list
   * @param copyHead/copyTail the method sets these to refer to the head and tail
   *                          node of the new list that is created
